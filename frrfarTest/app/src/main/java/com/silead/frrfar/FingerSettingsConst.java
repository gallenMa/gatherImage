...
public class FingerSettingsConst {
    ...
    public static final String FP_SETTINGS_ICON_IMAGE_SIZE = "iconsize";
    ...
    public static final boolean FP_SETTINGS_ICON_IMAGE_SIZE_DEFAULT = false;
    ...
    public static final String OPTIC_SETTINGS_FINGER_IMAGE_ROTATION = "rotation";
    public static final int OPTIC_SETTINGS_FINGER_IMAGE_MROTATION = 0;
    ...
    public static final int OPTIC_SETTINGS_FINGER_IMAGE_WIDTH_DEFAULT = 192;
    public static final int OPTIC_SETTINGS_FINGER_IMAGE_HEIGHT_DEFAULT = 192;
