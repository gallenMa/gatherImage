...
public class FingerImageSettingActivity extends Activity implements View.OnClickListener {
    ...
    private Button mFingerImageRoPlusBtn;
    private Button mFingerImageRoSubBtn;
    private TextView mFingerImageRotation;
    ...
    private int opIcon = 0;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.finger_image_main_optic);
        Log.d(FingerSettingsConst.LOG_TAG,"onCreate");
        ...
        mFingerImageRoPlusBtn = (Button) findViewById(R.id.finger_image_setting_plus_rotation);
        mFingerImageRotation = (TextView) findViewById(R.id.finger_image_layout_rotatioon);
        mFingerImageRoSubBtn = (Button) findViewById(R.id.finger_image_setting_plus_rotation);
        ...
        if(mFingerImageRoPlusBtn != null){
            mFingerImageRoPlusBtn.setOnClickListener(this);
        }
        if(mFingerImageRoSubBtn != null){
            mFingerImageRoSubBtn.setOnClickListener(this);
        }
    ...
    public void onClick(View v) {
        if (v == mFingerImageBackBtn) {
            ...
            SharedPreferencesData.saveDataInt(this,FingerSettingsConst.OPTIC_SETTINGS_CONFIG,
                    FingerSettingsConst.OPTIC_SETTINGS_FINGER_IMAGE_ROTATION,mRotation);
            finish();
            ...
            opIcon = 0;
            updateIconPosition(-1);
        }else if(v == mFingerImageRoPlusBtn){
            opIcon = 1;
            updateIconPosition(-1);
        }else if(v == mFingerImageRoSubBtn){
               opIcon = 1;
               updateIconPosition(1);
    ...
    private void updateIconPosition(int offset) {
        if (mFingerprintImage != null) {
            ...
            if (opIcon == 0){
                ...
                Log.d(FingerSettingsConst.LOG_TAG, " roatation operation offset: "+offset);
                mRotation +=offset;
                if(mRotation > 180){
                    mRotation = 0;
                }else if(mRotation < 0){
            ...
            if (mFingerImageYTextView != null && opIcon == 0) {
                mFingerImageYTextView.setText(Integer.toString(mFingerprintImageCenter));
            }
            if(mFingerImageRotation != null && opIcon == 1){
                mFingerImageRotation.setText(Integer.toString(mRotation));
            }
        }
    }
